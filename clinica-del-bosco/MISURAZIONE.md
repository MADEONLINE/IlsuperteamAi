...
| 3   | **Assistente e Indicazioni** (`assistente_aperto`, `assistente_domanda`, `click_indicazioni`)                                                 | Plausible → Goals                                                                                   | Misurano chi sta per venire o chi preferisce scrivere                                                                | Indicazioni in crescita nelle ore notturne              |
